document.getElementById('toggle-quick-links').addEventListener('click', function() {
  ...
  },
  {
    ...
    additionalEventInfo: '<b>Monday, December 2<br>5 PM<br><a class="dark-anchor" href="#">Join on Zoom ></a></b><br><br>The Yale School of Art offers MFA graduates the opportunity to teach students incarcerated in Connecticut correctional institutions through the Yale Prison Education Initiative at Dwight Hall and its partnerships with Yale Summer Session and the University of New Haven. Meet YPEI staff to learn more about this teaching fellowship. Apps will be due in January.',
    color: '#DB8780'
  },
  {
    dateNumber: '02',
